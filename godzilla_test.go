...
func setupGodzilla(settings ...*Settings) *godzilla {
	gz := new(godzilla)
...
func startGodzilla(gz *godzilla) {
	gz.setupRouter()
...
func makeRequest(request *http.Request, gz *godzilla) (*http.Response, error) {
...
func registerRoute(gz Godzilla, method, path string, handler func(ctx Context)) {
	switch method {
	case MethodGet:
		gz.Get(path, handler)
	case MethodHead:
...
// TestMethods tests creating Godzilla instance, registering routes, making
...
func TestMethods(t *testing.T) {
	...
	// get instance of Godzilla
	gz := setupGodzilla(&Settings{
...
func TestStatic(t *testing.T) {
	...
	testCases := []struct {
		...
		{method: MethodGet, path: "/static/Godzilla.png", statusCode: StatusOK},
	}
